...
class ExercisesPageCalisthenics extends StatefulWidget {
  final String muscleGroup;
  const ExercisesPageCalisthenics({super.key, required this.muscleGroup});

  @override
  _ExercisesPageStateCalisthenics createState() => _ExercisesPageStateCalisthenics();
}

class _ExercisesPageStateCalisthenics extends State<ExercisesPageCalisthenics> {
  ...
  Future<void> _fetchExercises() async {
    final exercisesSnapshot = await FirebaseFirestore.instance
        .collection('default-boxing-exercises')
