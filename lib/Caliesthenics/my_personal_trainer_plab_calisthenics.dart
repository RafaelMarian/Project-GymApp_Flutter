...
class MyPersonalTrainerPlanPageCalisthenics extends StatefulWidget {
  const MyPersonalTrainerPlanPageCalisthenics({super.key});

  @override
  _AllTrainingPlansPageStateCalisthenics createState() => _AllTrainingPlansPageStateCalisthenics();
}

class _AllTrainingPlansPageStateCalisthenics extends State<MyPersonalTrainerPlanPageCalisthenics> {
