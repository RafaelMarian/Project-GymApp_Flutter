...
class AddExerciseCalisthenicsPage extends StatefulWidget {
  const AddExerciseCalisthenicsPage({super.key});

  @override
  _AddExerciseCalisthenicsPageState createState() => _AddExerciseCalisthenicsPageState();
}

class _AddExerciseCalisthenicsPageState extends State<AddExerciseCalisthenicsPage> {
