...
class PlannedCyclingProgramsPageIndoor extends StatefulWidget {
  const PlannedCyclingProgramsPageIndoor({super.key});

  @override
  _PlannedCyclingProgramsPageStateIndoor createState() => _PlannedCyclingProgramsPageStateIndoor();
}

class _PlannedCyclingProgramsPageStateIndoor extends State<PlannedCyclingProgramsPageIndoor> {
  ...
  Future<void> _fetchWorkoutPlan() async {
    if (selectedDifficulty != null) {
      final querySnapshot = await FirebaseFirestore.instance
          .collection('planned_cycling_programs_Indoor')
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Planned Indoor Programs'),
