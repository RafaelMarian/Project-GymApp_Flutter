...
class AddExerciseBoxingPage extends StatefulWidget {
  const AddExerciseBoxingPage({super.key});

  @override
  _AddExerciseBoxingPageState createState() => _AddExerciseBoxingPageState();
}

class _AddExerciseBoxingPageState extends State<AddExerciseBoxingPage> {
