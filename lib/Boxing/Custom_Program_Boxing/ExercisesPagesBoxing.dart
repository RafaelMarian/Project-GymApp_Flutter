...
class ExercisesPageBoxing extends StatefulWidget {
  final String muscleGroup;
  const ExercisesPageBoxing({super.key, required this.muscleGroup});

  @override
  _ExercisesPageStateBoxing createState() => _ExercisesPageStateBoxing();
}

class _ExercisesPageStateBoxing extends State<ExercisesPageBoxing> {
