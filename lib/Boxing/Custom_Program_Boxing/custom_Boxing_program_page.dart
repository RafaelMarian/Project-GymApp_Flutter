...
import 'ExercisesPagesBoxing.dart';
import 'SlideRightRoutePage.dart';

class CustomBoxingProgramPage extends StatefulWidget {
  const CustomBoxingProgramPage({super.key});

  @override
  _CustomBoxingProgramPageState createState() => _CustomBoxingProgramPageState();
}

class _CustomBoxingProgramPageState extends State<CustomBoxingProgramPage> {
