...
class CreateTrainingPlanPageBoxing extends StatefulWidget {
  const CreateTrainingPlanPageBoxing({super.key});

  @override
  _CreateTrainingPlanPageStateBoxing createState() => _CreateTrainingPlanPageStateBoxing();
}

class _CreateTrainingPlanPageStateBoxing extends State<CreateTrainingPlanPageBoxing> {
  String? clientID;
  String? clientName;
  String? difficulty;
  String? workoutType;
