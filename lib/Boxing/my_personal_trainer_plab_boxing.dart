...
class MyPersonalTrainerPlanPageBoxing extends StatefulWidget {
  const MyPersonalTrainerPlanPageBoxing({super.key});

  @override
  _AllTrainingPlansPageStateBoxing createState() => _AllTrainingPlansPageStateBoxing();
}

class _AllTrainingPlansPageStateBoxing extends State<MyPersonalTrainerPlanPageBoxing> {
