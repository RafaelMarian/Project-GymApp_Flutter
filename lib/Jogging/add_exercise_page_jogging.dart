...
class AddExerciseJoggingPage extends StatefulWidget {
  const AddExerciseJoggingPage({super.key});

  @override
  _AddExerciseJoggingPageState createState() => _AddExerciseJoggingPageState();
}

class _AddExerciseJoggingPageState extends State<AddExerciseJoggingPage> {
