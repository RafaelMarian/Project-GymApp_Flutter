...
class CreateTrainingPlanPageJogging extends StatefulWidget {
  const CreateTrainingPlanPageJogging({super.key});

  @override
  _CreateTrainingPlanPageStateJogging createState() => _CreateTrainingPlanPageStateJogging();
}

class _CreateTrainingPlanPageStateJogging extends State<CreateTrainingPlanPageJogging> {
  String? clientID;
  String? clientName;
  String? difficulty;
  String? workoutType;
