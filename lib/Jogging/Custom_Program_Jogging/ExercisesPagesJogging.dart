...
class ExercisesPageJogging extends StatefulWidget {
  final String muscleGroup;
  const ExercisesPageJogging({super.key, required this.muscleGroup});

  @override
  _ExercisesPageStateJogging createState() => _ExercisesPageStateJogging();
}

class _ExercisesPageStateJogging extends State<ExercisesPageJogging> {
