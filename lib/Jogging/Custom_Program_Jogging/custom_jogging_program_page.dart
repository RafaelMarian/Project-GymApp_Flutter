...
import 'ExercisesPagesJogging.dart';
import 'SlideRightRoutePage.dart';

class CustomJoggingProgramPage extends StatefulWidget {
  const CustomJoggingProgramPage({super.key});

  @override
  _CustomJoggingProgramPageState createState() => _CustomJoggingProgramPageState();
}

class _CustomJoggingProgramPageState extends State<CustomJoggingProgramPage> {
  ...
  void _selectMuscleGroup(String group) {
    setState(() {
      ...
      Navigator.push(
        context,
        SlideRightRoute(
          widget: ExercisesPageJogging(muscleGroup: group),
        ),
      );
    });
  }
