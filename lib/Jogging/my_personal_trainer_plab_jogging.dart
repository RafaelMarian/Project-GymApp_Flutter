...
class MyPersonalTrainerPlanPageJogging extends StatefulWidget {
  const MyPersonalTrainerPlanPageJogging({super.key});

  @override
  _AllTrainingPlansPageStateJogging createState() => _AllTrainingPlansPageStateJogging();
}

class _AllTrainingPlansPageStateJogging extends State<MyPersonalTrainerPlanPageJogging> {
