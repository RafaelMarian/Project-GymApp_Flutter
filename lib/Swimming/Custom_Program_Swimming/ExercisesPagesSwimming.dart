...
class ExercisesPageSwimming extends StatefulWidget {
  final String muscleGroup;
  const ExercisesPageSwimming({super.key, required this.muscleGroup});

  @override
  _ExercisesPageStateSwimming createState() => _ExercisesPageStateSwimming();
}

class _ExercisesPageStateSwimming extends State<ExercisesPageSwimming> {
