...
import 'package:gym_buddies/Swimming/Custom_Program_Swimming/ExercisesPagesSwimming.dart';
import 'package:gym_buddies/Swimming/Custom_Program_Swimming/SlideRightRoutePage.dart';

class CustomSwimmingProgramPage extends StatefulWidget {
  const CustomSwimmingProgramPage({super.key});

  @override
  _CustomSwimmingProgramPageState createState() => _CustomSwimmingProgramPageState();
}

class _CustomSwimmingProgramPageState extends State<CustomSwimmingProgramPage> {
  ...
  void _selectMuscleGroup(String group) {
    setState(() {
      ...
      Navigator.push(
        context,
        SlideRightRoute(
          widget: ExercisesPageSwimming(muscleGroup: group),
        ),
      );
    });
  }
