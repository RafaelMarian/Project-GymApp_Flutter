...
class AddExerciseSwimmingPage extends StatefulWidget {
  const AddExerciseSwimmingPage({super.key});

  @override
  _AddExerciseSwimmingPageState createState() => _AddExerciseSwimmingPageState();
}

class _AddExerciseSwimmingPageState extends State<AddExerciseSwimmingPage> {
