...
class MyPersonalTrainerPlanPageSwimming extends StatefulWidget {
  const MyPersonalTrainerPlanPageSwimming({super.key});

  @override
  _AllTrainingPlansPageStateSwimming createState() => _AllTrainingPlansPageStateSwimming();
}

class _AllTrainingPlansPageStateSwimming extends State<MyPersonalTrainerPlanPageSwimming> {
