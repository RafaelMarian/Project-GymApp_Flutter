...
class _SwimmingProgramSelectionPageState
    extends State<SwimmingProgramSelectionPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor:
            const Color.fromARGB(255, 40, 39, 41), // Dark background color
      ),
  ...
  Widget _buildProgramButton(
    ...
    return Padding(
      padding:
          const EdgeInsets.symmetric(vertical: 10.0), // Spacing between buttons
