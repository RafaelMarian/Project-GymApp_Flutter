...
class CreateTrainingPlanPageSwimming extends StatefulWidget {
  const CreateTrainingPlanPageSwimming({super.key});

  @override
  _CreateTrainingPlanPageStateSwimming createState() => _CreateTrainingPlanPageStateSwimming();
}

class _CreateTrainingPlanPageStateSwimming extends State<CreateTrainingPlanPageSwimming> {
  String? clientID;
  String? clientName;
  String? difficulty;
  String? workoutType;
